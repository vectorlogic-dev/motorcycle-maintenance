# Starter maintenance template sources

Last reviewed: 2026-07-31

MotoCare's starter schedule is a conservative, model-agnostic starting point for ordinary road motorcycles. It is not a manufacturer schedule. Every item is editable or can be deactivated, and users must confirm the correct work, parts, fluids, and intervals against the motorcycle owner's manual or dealer booklet.

## Starter intervals

| Item | Distance | Time | Basis |
| --- | ---: | ---: | --- |
| Engine oil change | 3,000 km | 365 days | Yamaha Philippines lists 3,000 km after its initial NMAX services; Suzuki lists 4,000 km or 12 months for the Address 110. |
...
- [Yamaha Motor Philippines NMAX PMS schedule](https://aftersales.yamaha-motor.com.ph/automatic/nmax-tech-max/)
- [Honda Click125i owner's manual](https://2rom-prd-data.hondamotopub.com/om/HPI/Click125i/2020/Click125i_32K60A101_0.pdf)
