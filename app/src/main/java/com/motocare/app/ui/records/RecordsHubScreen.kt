...
fun RecordsHubScreen(
    ...
    LazyColumn(
        ...
        item { MotoCarePageHeader(title = "Records & tools", subtitle = "Everything important, organised in one place", icon = Icons.Outlined.Description) }
        item { MotoCareLinkCard("Free maintenance coverage", "Track the one-year or kilometre limit", Icons.Outlined.HealthAndSafety, onCoverage) }
        item { MotoCareLinkCard(
        ...
        item { MotoCareLinkCard("Reports", "Explore monthly riding and ownership costs", Icons.Outlined.Assessment, onReports) }
        item { MotoCareLinkCard(
            "Backup & export",
